...
var completed = {
    fish: { 1:false, 2:false, 3:false, 4:false, 5:false, 6:false, 7:false
    }
}
...
function toggleCompletion(type, id) {
    console.log("hello");
    // figure out what was clicked, and push/save it to the var
    completed[type][id] = !completed[type][id]
}
function DeleteRows() {
